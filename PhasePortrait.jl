...
function phaseplot(model, x1lim, x2lim; clines=true, xinit=(), t=(0.0,50.0),
    ...
    if clines
            ...
            contour!(x1_range, x2_range, v, lw=3, linestyle=:dot, c=:red,
                    ...
                    levels=[0], colorbar = :none, xaxis=("D1", (x1lim[1], x1lim[2])),

                    yaxis=("D2",(x2lim[1], x2lim[2])))
...
#        plot!(sol, vars=(1,2), lw=2, c=:black, legend = :none, xaxis=("A",

#            (x1lim[1], x1lim[2])), yaxis=("R",(x2lim[1], x2lim[2])))
